# catchall_error_email

This is a sample template for catchall_error_email - Below is a brief explanation of what we have generated for you:
...
sam deploy \
    ...
    --stack-name catchall_error_email \
...
```bash
sam logs -n HelloWorldFunction --stack-name catchall_error_email --tail
```
...
```bash
aws cloudformation delete-stack --stack-name catchall_error_email
```
